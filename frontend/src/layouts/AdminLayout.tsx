...
export function AdminLayout() {
  ...
  return <div className="admin-shell"><aside className="admin-sidebar"><a className="admin-logo" href="/">✳ <span>TECHROULETTE</span></a><div className="admin-sidebar-label">CONTROL ROOM</div><nav aria-label="Admin navigation">
    ...
    {user?.role !== 'STAFF' && <>
      <NavLink to="/admin/certificates">▤ <span>Certificates</span></NavLink>
      <NavLink to="/admin/certificates/templates">▧ <span>Certificate templates</span></NavLink>
      ...
      <NavLink to="/admin/email/campaigns">◷ <span>Campaigns</span></NavLink>
    </>}
